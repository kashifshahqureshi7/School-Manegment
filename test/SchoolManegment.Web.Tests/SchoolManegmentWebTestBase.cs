...
{
    public abstract class SchoolManegmentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SchoolManegmentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SchoolManegmentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SchoolManegmentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SchoolManegmentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SchoolManegmentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SchoolManegmentDbContext, Task<T>> func)
        {
            T result;
